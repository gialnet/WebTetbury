...
{  
    ...
    //alert(myfila);
    // hay que añadir el recargo de equivalencia !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    //CallRemote('AjaxServlet', 'accion=NuevaFactura&myJson='+myJsonString);
    newfactura.submit();
...
//alert(obj.length);
        ...
        tabla.AddRowCellText(row, 6,
                '<div> <a href="#" class="btn tip" title="Eliminar Concepto"> <i class="icon-trash"> </i> </a></div>');
//<a href="#" class="btn tip" title="Eliminar Concepto"> <i class="icon-trash"> </i> </a>                
...
function BuscarDatosDB(Nombre)
{
    ...
    CallRemote('AjaxServlet', 'accion=LeerDatosClientes&cuantos=lista_nombres&xNombre=' + Nombre);
 ...
 * @returns {undefined}
 */
function LeerDatosClientes(idLista,myJson)
{
...
function VerPDF(numFila)
{
    ...
    window.location.href = 'pdfServlet?xID='+oCelda.innerHTML;
}
...
function test() {
  ...
  obj.Nombre=document.getElementById('xNombre').value;
  obj.Fecha =document.getElementById('xFecha').value;
  
  rejilla.concepto="concepto 1";
  rejilla.unidades="1";
  rejilla.iva="21";
  rejilla.importe="1512";
